...
from . import (lang_AR, lang_CZ, lang_DE, lang_DK, lang_EN, lang_EN_IN,
               ...
               lang_FR_CH, lang_FR_DZ, lang_HE, lang_HI, lang_ID, lang_IT,
               lang_JA, lang_KN, lang_KO, lang_LT, lang_LV, lang_MR, lang_NL,
               lang_NO, lang_PL, lang_PT, lang_PT_BR, lang_RO, lang_RU,
               lang_SL, lang_SR, lang_TA, lang_TH, lang_TR, lang_UK, lang_VI)
